...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("PicoCross2024", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("PicoCross2024", null, 1920, 1080);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "PicoCross2024";
		app.meta["name"] = "Pico Cross 2024";
